...
function TermsConditions({ setShowTermsModal, TermsText }) {
  return (
    ...
    >
      <div
        className={
          "w-11/12 lg:w-[60vw] z-[60] h-full lg:h-[65vh] flex flex-col space-y-3 px-4 lg:px-8 py-10 lg:py-10 border border-gray-200/20 rounded-sm bg-[#2c304d3c] backdrop-blur-md"
        }
      >
